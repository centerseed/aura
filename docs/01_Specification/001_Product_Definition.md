...
# Naruvia Product Definition (產品白皮書)

**Ver 2.0 - The Entropy-Reducing OS for High-Performance Minds**

Naruvia 不僅僅是一個筆記軟體或待辦清單，它是一個具備「治理智慧」的第二大腦作業系統。旨在透過 AI 代理（Agents）的協作，自動對抗資訊熵（Information Entropy），將創辦人與高階專業人士從混亂的資訊洪流中解放出來。
...
Naruvia 透過嚴謹的三層架構來映射用戶的多重身分與資產：

| Layer | Concept | Definition | Example |
| :--- | :--- | :--- | :--- |
| **L1** | **Area (Identity)** | **"Who am I?"**<br>長期身分認同與責任邊界。是協作與隱私的容器。 | `02_Employee_Google`<br>`05_Founder_Naruvia`<br>`01_Life_Personal` |
| **L2** | **Product (Asset)** | **"What am I building?"**<br>具備產出價值或需持續維護的資產實體。 | `Naruvia_Backend_System`<br>`My_Physical_Health`<br>`Q3_Financial_Report` |
...
Naruvia 透過三位專職 Agent 分工合作，實現全自動化的資訊後勤 (Information Logistics)：
...
Naruvia 專為 **"High-Context Individuals" (高語境個體)** 設計：
