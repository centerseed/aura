 ...
 * Uses Zod for runtime validation matching the spec's parameter constraints.
 */
...
/** Schema for capture_thought tool (Section 4.1) */
...
/** Schema for append_to_knowledge tool (Section 4.2) */
...
/** Schema for query_memory tool (Section 4.3) */
