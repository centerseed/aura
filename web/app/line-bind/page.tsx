    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="max-w-sm w-full bg-slate-900 border border-slate-700 rounded-2xl p-8 text-center space-y-4">
        ...
        <p className="text-slate-400 text-sm leading-relaxed">
          LINE 內建瀏覽器不支援 Google / Apple 登入。<br />
          請點右上角「⋯」→「在瀏覽器中開啟」
        </p>
      </div>
    </div>
        ...
        {state === "login-required" && (
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-black hover:bg-slate-900 text-white font-medium text-sm py-3 px-4 rounded-xl transition-colors border border-slate-700"
            >
